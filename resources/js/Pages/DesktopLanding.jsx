    ...
    <div className="w-full flex flex-col">
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-center bg-[#f2e8d9] overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl">
          ...
          {/* CTA Button - Replaced with Inertia Link to Login */}
         ...
         >
           ...
           <div
             className={`absolute w-full h-full transition-all duration-3000 transform backface-hidden ${
               flipped[i] ? "rotate-y-180 opacity-0 z-0" : "rotate-y-0 opacity-100 z-10"
             }`}
           >
              <div className={`${s.color} w-full h-full flex flex-col md:flex-row items-center justify-center relative`}>
                
                {/* Decorative Background Element */}
                <div className="absolute top-10 left-10 text-[20rem] opacity-10 rotate-12 select-none pointer-events-none text-white">
                  {s.icon}
                </div>
           ...
           {/* =========================================
               ...
               ========================================= */}
           <div
              className={`absolute w-full h-full transition-all duration-2000 transform backface-hidden ${
