...
export default function RepairerDesktop({ 
        ...
        return (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                ...
                <div className="bg-white w-[900px] h-[600px] rounded-2xl relative z-10 shadow-2xl flex overflow-hidden animate-scale-up">
                    ...
                    {/* LEFT SIDE: MAP */}
                    <div className="w-1/2 bg-[#faf9f6] relative h-full">
                        <MapContainer 
                            key={job.id} 
                            center={mapCenter} 
                            zoom={13} 
                        ...
                        <div className="absolute bottom-6 left-6 z-[500] bg-white/90 backdrop-blur-md px-4 py-3 rounded-xl shadow-lg border border-white/50">
                             <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-black text-[#5d4037] leading-none text-lg">{distance} km</p>
                                </div>
                             </div>
                        </div>
                        ...
                        {hasCustomerLocation && (
                            <button 
                                ...
                                className="absolute bottom-6 right-6 z-[500] bg-[#5d4037] text-white h-14 w-14 rounded-full shadow-xl flex items-center justify-center text-2xl hover:bg-[#8c6745] active:scale-95 transition-transform border-4 border-white"
                    ...
                    <div className="w-1/2 p-8 flex flex-col h-full bg-white">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                ...
                                <h2 className="text-3xl font-black text-[#5d4037] leading-tight">{job.service_type}</h2>
                            </div>
                            <button onClick={onClose} className="bg-[#faf9f6] hover:bg-[#e6d0c0] p-2 rounded-full transition-colors text-[#5d4037]">
                                ✕
                            </button>
                        </div>
                        ...
                        <div className="space-y-6 flex-grow overflow-y-auto pr-2">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="h-12 w-12 bg-[#faf9f6] rounded-full flex items-center justify-center text-xl font-black text-[#dcb6a2] border border-[#f2e8d9]">
                                    {job.customer?.name.charAt(0)}
                                </div>
                                <div>
                                    <p className="text-[10px] text-gray-400 font-bold uppercase">Customer Name</p>
                                    <p className="font-bold text-[#5d4037] text-lg">{job.customer?.name}</p>
                                </div>
                            </div>

                            {/* Date Row */}
                            <div className="flex items-center gap-4">
                                <div className="h-12 w-12 flex items-center justify-center text-xl bg-[#f2e8d9] rounded-xl text-[#5d4037]">📅</div>
                                <div>
                        ...
                        {/* Footer Actions */}
                        <div className="pt-6 border-t border-[#faf9f6] mt-auto">
                            {job.status === 'pending' ? (
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <button 
                                        ...
                                        className="py-4 rounded-xl bg-[#5d4037] text-white font-bold shadow-xl hover:bg-[#8c6745] transition-colors"
                                    >
                                        Accept Job
                                    </button>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button 
                                        ...
                                        className="py-4 rounded-xl bg-[#f2e8d9] text-[#5d4037] font-bold border border-[#dcb6a2] hover:bg-[#e6d0c0] transition-colors"
                                    >
                                        Message
                                    </button>
                                    <button 
                                        onClick={() => handleCompleteAndClose(job.id)}
                                        className="py-4 rounded-xl bg-[#b86c45] text-white font-bold hover:bg-[#a65d3a] shadow-lg transition-colors"
                                    >
                                        Complete Job
                                    </button>
                                </div>
        ...
        <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-bold relative ${
                ...
                : disabled 
                    ...
                    : 'text-gray-500 hover:bg-[#f2e8d9] hover:text-[#5d4037]'
            }`}
        >
    ...
    const JobsMenu = () => {
        ...
        return (
            <div className="animate-fade-in-up space-y-8">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-[#5d4037] mb-6">Job Overview</h2>
                    <div className="grid grid-cols-3 gap-6">
                        <button onClick={() => handleOpenJobList('pending')} className="bg-orange-50 border border-orange-100 p-8 rounded-2xl flex flex-col items-start hover:shadow-md transition-all group text-left">
                            <div className="h-14 w-14 bg-white rounded-full flex items-center justify-center text-2xl font-black text-orange-600 shadow-sm mb-4 group-hover:scale-110 transition-transform">{pendingCount}</div>
                            <h3 className="text-xl font-black text-orange-900">Pending Requests</h3>
                            <p className="text-sm text-orange-700 mt-1">Review and accept new jobs.</p>
                        </button>

                        <button onClick={() => handleOpenJobList('confirmed')} className="bg-[#f2e8d9] border border-[#dcb6a2] p-8 rounded-2xl flex flex-col items-start hover:shadow-md transition-all group text-left">
                            <div className="h-14 w-14 bg-white rounded-full flex items-center justify-center text-2xl font-black text-[#5d4037] shadow-sm mb-4 group-hover:scale-110 transition-transform">{activeCount}</div>
                            <h3 className="text-xl font-black text-[#5d4037]">Active Jobs</h3>
                            <p className="text-sm text-[#8c6745] mt-1">Jobs currently in progress.</p>
                        </button>
                ...
                {nextJob ? (
                    <div className="bg-white rounded-2xl shadow-lg border-l-8 border-[#b86c45] p-8 flex items-center justify-between">
                        <div className="flex gap-6 items-center">
                            <div className="bg-[#f2e8d9] text-[#5d4037] px-6 py-4 rounded-xl text-center min-w-[100px] border border-[#dcb6a2]">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-[#5d4037] mb-1">{nextJob.service_type}</h3>
                                <div className="flex items-center gap-3 text-gray-500 text-sm mb-2">
                                    <span className="flex items-center gap-1 font-medium text-gray-900">
                                        <div className="w-5 h-5 bg-[#faf9f6] rounded-full flex items-center justify-center text-[10px] font-bold text-[#b86c45] border border-[#dcb6a2]">
                        ...
                        <button 
                            ...
                            className="bg-[#5d4037] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#8c6745] transition-colors shadow-md flex items-center gap-2"
                        >
                            View Job details →
                        </button>
                    </div>
                ) : (
                    <div className="bg-[#faf9f6] border border-[#f2e8d9] rounded-2xl p-8 text-center border-dashed">
                        <p className="text-[#a57c52] font-bold">No upcoming jobs scheduled. You are all clear!</p>
                    </div>
                )}
            </div>
        );
    ...
    const JobsList = () => {
        ...
        return (
            <div className="bg-white rounded-2xl shadow-sm border border-[#f2e8d9] overflow-hidden animate-fade-in-right">
                <div className="p-6 border-b border-[#faf9f6] flex items-center gap-4">
                    <button 
                        onClick={() => setJobsSubView('menu')}
                        className="p-2 bg-[#faf9f6] hover:bg-[#f2e8d9] rounded-full transition-colors text-[#5d4037]"
                    >
                        ← Back
                    </button>
                ...
                <table className="w-full text-left">
                    <thead className="bg-[#faf9f6] text-gray-500 text-xs uppercase font-bold">
                        <tr>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {filteredJobs.map(job => (
                            <tr key={job.id} className="hover:bg-[#faf9f6] transition-colors cursor-pointer" onClick={() => setSelectedJob(job)}>
                                <td className="px-6 py-4">
                                    <div className="font-bold text-[#5d4037]">{job.service_type}</div>
                                ...
                                <td className="px-6 py-4 text-right">
                                    <button 
                                        ...
                                        className="text-[#b86c45] hover:underline text-xs font-bold"
                                    >
                                        View Details
                                    </button>
                                </td>
    ...
    const ChatsView = () => (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {conversations.length === 0 ? (
                <div className="col-span-full py-20 text-center bg-white rounded-2xl border border-dashed border-[#dcb6a2]">
                ...
                conversations.map(chat => (
                    <div key={chat.id} onClick={() => handleOpenChat(chat.booking_id)} className="bg-white p-5 rounded-2xl shadow-sm border border-[#f2e8d9] hover:shadow-md transition-shadow cursor-pointer group">
                        <div className="flex justify-between items-start mb-4">
                            <div className="flex items-center gap-3">
                                <div className="h-10 w-10 bg-[#faf9f6] rounded-full overflow-hidden"><img src={`https://ui-avatars.com/api/?name=${chat.other_user_name}&background=random`} className="h-full w-full object-cover"/></div>
                                <div><h3 className="font-bold text-[#5d4037] group-hover:text-[#b86c45] transition-colors">{chat.other_user_name}</h3><p className="text-xs text-gray-500">{chat.last_message_time || 'Just now'}</p></div>
                            </div>
                        ...
                        <div className="mt-4 pt-3 border-t border-[#faf9f6] flex justify-end"><span className="text-xs font-bold text-[#b86c45] group-hover:underline">Open Conversation →</span></div>
                    </div>
                ))
            )}
        </div>
    ...
    const ScheduleView = () => (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
             <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#f2e8d9] h-fit">
                <h3 className="font-bold text-lg mb-2 text-[#5d4037]">Calendar Sync</h3>
                ...
                {isGoogleConnected ? (
                    ...
                    <a href="/auth/calendar/connect" className="block w-full text-center bg-[#b86c45] text-white py-2 rounded-lg font-bold hover:bg-[#a65d3a]">Connect Google Calendar</a>
                )}
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-[#f2e8d9] overflow-hidden">
                <div className="p-6 border-b border-[#f2e8d9] flex justify-between items-center">
                    <h3 className="font-bold text-lg text-[#5d4037]">Weekly Availability</h3>
                    {processing && <span className="text-xs text-[#b86c45] animate-pulse">Saving...</span>}
                </div>
                <div className="divide-y divide-[#faf9f6]">
                    {data.schedule.map((day, index) => (
                        <div key={day.day_of_week} className="p-4 flex items-center justify-between hover:bg-[#faf9f6] transition-colors">
                            <div className="flex items-center gap-4 w-1/3">
                                <input type="checkbox" checked={day.is_active} onChange={(e) => updateDay(index, 'is_active', e.target.checked)} className="w-5 h-5 rounded text-[#5d4037] focus:ring-[#5d4037] border-gray-300 cursor-pointer"/>
                                <span className={`font-bold ${day.is_active ? 'text-[#5d4037]' : 'text-gray-400'}`}>{DAYS[day.day_of_week]}</span>
                            </div>
                            <div className="flex-1 flex justify-end">
                                {day.is_active ? (
                                    <div className="flex items-center gap-3">
                                        <input type="time" value={day.start_time} onChange={(e) => updateDay(index, 'start_time', e.target.value)} className="bg-white border border-[#dcb6a2] rounded-lg text-sm px-3 py-2 text-[#5d4037]"/>
                                        <span className="text-gray-400 font-bold">-</span>
                                        <input type="time" value={day.end_time} onChange={(e) => updateDay(index, 'end_time', e.target.value)} className="bg-white border border-[#dcb6a2] rounded-lg text-sm px-3 py-2 text-[#5d4037]"/>
                                    </div>
                ...
                <div className="p-6 bg-[#faf9f6] border-t border-[#f2e8d9]">
                    <button onClick={saveSchedule} disabled={processing} className="w-full bg-[#5d4037] text-white py-3 rounded-xl font-bold shadow-lg hover:bg-[#8c6745] disabled:opacity-50 transition-all transform active:scale-95">
    ...
    if (!isGoogleConnected) {
        return (
            <div className="min-h-screen bg-[#faf9f6] flex items-center justify-center">
                <div className="bg-white p-10 rounded-2xl shadow-xl max-w-lg text-center border border-[#dcb6a2]">
                    <div className="w-20 h-20 bg-[#f2e8d9] text-[#5d4037] rounded-full flex items-center justify-center text-4xl mx-auto mb-6">📅</div>
                    <h1 className="text-3xl font-black text-[#5d4037] mb-3">One Last Step!</h1>
                    ...
                    <a href="/auth/calendar/connect" className="block w-full bg-[#5d4037] text-white text-lg font-bold py-4 rounded-xl hover:bg-[#8c6745] transition-transform hover:scale-105">Connect Calendar & Continue →</a>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#faf9f6] flex font-sans">
            ...
            {/* LEFT SIDEBAR */}
            <aside className="w-64 bg-white border-r border-[#f2e8d9] fixed h-full p-6 flex flex-col justify-between z-10">
                <div>
                ...
                {/* Bottom Profile */}
                <div className="border-t border-[#f2e8d9] pt-6 space-y-3">
                    <div className="flex items-center gap-3 px-2">
                        <div className="w-10 h-10 bg-[#faf9f6] rounded-full flex items-center justify-center font-bold text-[#b86c45] text-sm border border-[#dcb6a2]">{user.name.charAt(0)}</div>
                        <div className="overflow-hidden">
                            <p className="text-sm font-bold truncate text-[#5d4037]">{profile?.business_name || user.name}</p>
                            {isOnSchedule ? (
                    ...
                    <button onClick={onSwitchToCustomer} className="w-full text-center text-xs font-bold text-[#b86c45] hover:text-[#8c6745] py-2 border border-[#dcb6a2] rounded-lg transition-colors">Switch to Customer</button>
