                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <div className="bg-white p-2 rounded-2xl shadow-sm border border-gray-100 space-y-1">
                            <button 
                                ...
                                className="w-full flex items-center justify-between px-4 py-4 hover:bg-gray-50 rounded-xl transition-colors group"
                            >
                            ...
                            <button 
                                ...
                                className="w-full flex items-center justify-between px-4 py-4 hover:bg-red-50 rounded-xl transition-colors group"
                            >
                                <div className="flex items-center gap-3">
